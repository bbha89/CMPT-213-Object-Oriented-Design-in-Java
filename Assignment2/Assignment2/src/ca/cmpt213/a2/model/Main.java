 ...
 * monsters. The class deals with collision detection that decides
 * the proper behaviour depending on maze cell values.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (alive && REMAINING > 0) {
            direction = inputDirection(myScanner, maze, monster);
    ...
    /**
     * Displays the maze with any
     * updated properties to the maze
     */
    private static void showMaze(Maze maze) {
        TextUI.mazeName();
        TextUI.fill(maze.getMaze());
    }
     ...
     */
    private static void hideMaze(Maze maze) {
     ...
     * the hero when handling collisions.
     */
    ...
    /**
     * added monster objects to an arraylist.
     * make cell values to monster.
     */
     ...
     */
    private static String inputDirection(Scanner myScanner, Maze maze, ArrayList<Monster> monster) {
        validInput = false;
        while (!validInput) {
            direction = userInput(myScanner);
            validateMovement(direction, maze, monster);
        }
        return direction;
    }
     ...
     * a help menu or a cheat menu.
     */
    private static void validateMovement(String direction, Maze maze, ArrayList<Monster> monster) {
    ...
    private static void details() {
        System.out.println(TextUI.monsters());
        System.out.println(TextUI.possession() + powerCount);
        System.out.println(TextUI.monstersRemaining() + REMAINING);
        TextUI.enter();
    }
}