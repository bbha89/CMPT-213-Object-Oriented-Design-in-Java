...
import ca.cmpt213.a2.model.Main;
import ca.cmpt213.a2.model.Value;

/**
 * Displays the values of each cell
...
public class TextUI {
    ...
    /**
     * Displays the character that will
     * appear in each cell in the matrix.
     */
    public static void fillMaze(Cell[][] maze) {
    ...
    public static void monsters() {
        System.out.println("Total number of monsters to be killed: " + Main.getTotalNeededKills());
    }
    public static void possession() {
        System.out.println("Number of powers currently in possession: " + Main.getPowerCount());
    }

    public static void monstersRemaining() {
        System.out.println("Number of monsters alive: " + Main.getRemaining());
    }
